...
class CGT(nn.Module):
    ...
    def forward(self, data):
        ...
        '''
        x, edge_index, edge_attr, energies, elec_conf, orbital_counts = data.x.long(), data.edge_index, data.edge_attr, data.energies, data.elec_conf, data.orbital_counts
        batch = data.batch  
        ...
        cell_orbital_totals = self.fc_orbital_counts(cell_orbital_totals)
        
        crys_fea = torch.cat((crys_fea, energies, cell_orbital_totals), dim=-1)
